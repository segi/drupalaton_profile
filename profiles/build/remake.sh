...
# Script for rebuilding the farmit_vf project to the same place, with the same settings.
set -e
...
script_name=$0
drupal_root=`pwd`
project_repo='git@github.com:csakiistvan/drupalaton_profile.git'
make_file_name='drupalaton_profile.make'
